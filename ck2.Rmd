...
## Logistic Lasso for diagnosis
```{r}
library(glmnet)
y = as.matrix(data_imputed$diag)

x = as.matrix(select(data_imputed, c('sex', 'age', 'sc1', 'sc2', 'dbp', 'sbp', 'smoke', 'bmi')))
...
## create categorical cexam for multinomial
```{r}
